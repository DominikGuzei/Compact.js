define(['Class'], function(Class) {
	...
	Class("Class.events.EventDispatcher") 
	...
	.methods ({
		...
		_addListener: function(type, eventName, listener) {
			...
			this.eventListeners[type][eventName].push(listener);
			return {
				type: type,
				eventName: eventName,
				index: this.eventListeners[type][eventName].length -1
			}
		}
	})
	...
	return Class.events.EventDispatcher;
});
